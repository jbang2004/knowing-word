/*
 * Authored extension character records.
 *
 * `originalText` stays empty in this legacy data shape. The lesson loader
 * injects a short project-authored theme context so no textbook excerpt can
 * enter a public character card from this file.
 */
import type { CharacterItem } from "./catalog-types";

export const extensionCharacters = [
  {
  ...
  },
  {
    ...
    "compositions": [
      ...
      {
        "char": "𧴪",
        "description": "“𧴪”在“锁”中承担字形和读音线索，学习时把它作为右侧完整部件辨认。",
        "charType": "声符记号",
        "children": []
      }
    ],
  ...
  },
  {
    ...
    "compositions": [
      {
        "char": "⺮",
        "description": "“⺮”是“竹”作偏旁时的写法，称为竹字头，通常提示字义与竹子或竹制品有关。",
        "charType": "",
        "children": []
      },
      {
  ...
  },
  {
    ...
    "compositions": [
      ...
      {
        "char": "㝵",
        "description": "“㝵”在“碍”中承担字形和读音线索，学习时把它作为右侧完整部件辨认。",
        "charType": "",
        "children": []
      }
    ],
  ...
  },
  {
    ...
    "compositions": [
      ...
      {
        "char": "⺀",
        "description": "“⺀”是由两点组成的字形部件，在“尽”中位于下方，学习时注意两点的方向和间距。",
        "charType": "",
        "children": []
      }
    ],
